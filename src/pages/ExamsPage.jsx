...
export default function ExamsPage() {
  ...
  const submitAnswer = async () => {
    ...
    setSaveError('');
    const { error } = await supabase.from('practice_attempts').insert({ user_id: user.id, practice_type: 'exam', question_id: activeQuestion.id, is_correct: selectedAnswer === activeQuestion.answer });
